...
import { minLength, mustMatch, required } from '../../../utils/validation/validators';
...
const runners = [
  ...
  ruleRunner('password2', 'Password Confirmation', required, mustMatch('password1', 'Password'))
];
  ...
  render () {
    ...
    return (
      <div className={ classList }>
        <AuthInfoTitle style={ { marginBottom: 20 } } text="Get Your Free Student Wallet Account" className="hide-tablet"/>
        ...
        <div className="text-gray text-small" style={ { margin: '14px 0' } }>
          Have an account? <a href="#" onClick={ this.redirectToLogin }>Sign in here</a>
        </div>
      </div>
    );
  }
...
export default connect(null, { displayLoginModal })(SignupForm);
